...
class GetAccountLookupResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'items' => '\Parenthesis\DingConnect\Model\AccountLookup[]',
        'result_code' => 'int',
     ...
     * Gets items
     *
     * @return \Parenthesis\DingConnect\Model\AccountLookup[]
     */
     ...
     * Sets items
     *
     * @param \Parenthesis\DingConnect\Model\AccountLookup[] $items This will contain provider information associated to the account number. If we can succesfully lookup the account number               the list will contain the info for products associated to it.
     *
     * @return $this
     */
